...
class OrderLineItem(models.Model):
    ...
    gift = models.ForeignKey(Gift, null=False, blank=False, on_delete=models.CASCADE)  # noqa
    gift_size = models.CharField(max_length=2, null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        ...
        """
        self.lineitem_total = self.gift.price * self.quantity
        super().save(*args, **kwargs)
